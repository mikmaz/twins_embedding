...
def scatter_combined(
    ...
    **kwargs,
    ...
    range_1 *= 1 + 2.0 * border
    range_2 *= 1 + 2.0 * border
    range_3 *= 1 + 2.0 * border
    ...
    plot_kwargs = {
        "s": default_settings["combined_scatter_plot_marker_size"],
        "edgecolors": "gray",
    }
    ...
    ax13.scatter(
        use_embedding[:, axis_1], use_embedding[:, axis_3], c=c13, **plot_kwargs
    )
    ...
    ax32.scatter(
        use_embedding[:, axis_3], use_embedding[:, axis_2], c=c32, **plot_kwargs
    )
